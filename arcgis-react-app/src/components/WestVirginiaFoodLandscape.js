...
const categories = [
  ...
  { title: 'Farmers Markets', icon: <Storefront sx={{ fontSize: 160, color: '#002855' }} />, description: 'Information on local farmer-to-consumer markets and nutrition incentives.', url: 'https://www.arcgis.com/apps/dashboards/5095c3fd9b0c4934be43bc8f65c93b36' },
  ...
  { title: 'Learn', icon: <LightbulbCircle sx={{ fontSize: 160, color: '#002855' }} />, description: 'Learn how to create just and sustainable communities.', url: 'https://resilientcommunities.wvu.edu/' }
];
